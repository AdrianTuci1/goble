...
fn icon_atlas_name(name: IconName) -> IconName {
    match name {
        ...
        "drive" | "layers" => "layers-three-01",
        "plug" | "mcp" | "connector" | "connectors" => "plug",
        "workflow" | "workflows" => "workflow",
        "activity" | "execution" | "executions" | "run" => "activity",
        ...
        "send" => "send",
        "mic" | "voice" | "microphone" => "mic",
        "key" => "key",
        "sliders" | "sliders-04" | "variant" => "sliders",
        "cpu" | "model" => "prompt",
        "sparkle" | "ai" | "stars" => "sparkle",
        "ai-assistant" | "agent-logo" => "ai-assistant",
        "copy" | "copy-transcript" => "copy",
        "refresh" | "restart" | "rerun" => "refresh",
        "terminal" => "terminal",
